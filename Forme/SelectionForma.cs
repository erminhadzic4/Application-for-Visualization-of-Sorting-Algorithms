...
{
    public partial class SelectionForma : Form
    {
        ...
        private void SelectionForma_Load(object sender, EventArgs e)
        {
            UcitajBoju();
        }
        ...
        public void w_IzvrsiWorkera(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                SortEngine engine = new SelectionSort(niz, g, panel1.Height);
