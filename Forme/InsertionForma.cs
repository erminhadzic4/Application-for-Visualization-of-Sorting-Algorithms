...
{
    public partial class InsertionForma : Form
    {
        ...
        private void InsertionForma_Load(object sender, EventArgs e)
        {
            UcitajBoju();
        }
        ...
        public void w_IzvrsiWorkera(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                SortEngine engine = new InsertionSort(niz, g, panel1.Height);
        ...
        {
            {
                ...
                w.RunWorkerAsync(argument: "InsertionSort");
            }
        }
    }
}
